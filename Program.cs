...
namespace Notes_Application
{
    class Program
    {
        ...
        {
            // Read the user input - then execute the correct method.
        ...
        private static void NewNote()
        {
            ...
            XmlWriterSettings NoteSettings = new XmlWriterSettings(); // Add XML settings, can be changed

            NoteSettings.CheckCharacters = false;
            NoteSettings.ConformanceLevel = ConformanceLevel.Auto;
            NoteSettings.Indent = true;

            string FileName = DateTime.Now.ToString("dd-MM-yy") + ".xml"; // Sets the file name to the date format.
